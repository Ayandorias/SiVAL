 ...
 *
 */
NW::FrameBarButton::FrameBarButton(const QString &icon, const QString &icon_hover, const QString icon_checked, const QString &icon_checked_hover, QWidget *parent, ToolButtonStyle style)
    :ToolButton(parent) {

    setMinimumSize(QSize(45, 35));
    setMaximumSize(QSize(45, 35));

    if(style == NW::FB_Normal) {
 ...
 *
 */
NW::FrameBarButton::~FrameBarButton() {
}
