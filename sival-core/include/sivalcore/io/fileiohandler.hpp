...
#include <sivalcore/abstractions/abstractiohandler.hpp>
 ...
 *
 */
class SIVAL_CORE_EXPORT FileIOHandler : public AbstractIOHandler
{
    //// begin public member methods
public:
    /// Constructor
    explicit FileIOHandler(const QString &filename);
    /// Destructor
