...
namespace SiVAL {
   ...
   *
   */
  class SIVAL_GUI_EXPORT Button : public QPushButton
  {
    Q_OBJECT
    //// begin public member methods
  public:
    /// Constructor
    explicit Button(const QString &label, SiVAL::Style *style, QWidget *parent = nullptr);
    ///
