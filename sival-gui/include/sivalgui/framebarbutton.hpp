 ...
 *
 */
class SIVAL_GUI_EXPORT FrameBarButton : public ToolButton
{
    Q_OBJECT
    //// begin public member methods
public:
    /// Constructor
    explicit FrameBarButton(const QString &icon, const QString &icon_hover, const QString icon_checked, const QString &icon_checked_hover, QWidget *parent = nullptr, SiVAL::ToolButtonStyle style = SiVAL::FB_Normal);
    /// Destructor
