...
/**************************************************************************************************/
/**
 * @brief SiVAL::NavBarPanel::NavBarPanel
 * @param parent
 */
SiVAL::NavBarPanel::NavBarPanel(QWidget *parent)
    :QWidget(parent) {
    ...
    SiVAL::NavBarButton *toolButton = new SiVAL::NavBarButton(":/sival/logo.svg", ":/sival/logo.svg", this, NB_Menu);
    toolButton->setMinimumSize(QSize(45, 45));
    toolButton->setMaximumSize(QSize(45, 45));
    toolButton->setObjectName("toolButton");

    connect(toolButton, &QToolButton::clicked, this, &SiVAL::NavBarPanel::mainMenu);
    ...
    connect(m_pGroup, &QButtonGroup::buttonClicked, this, &SiVAL::NavBarPanel::selection);
}
/**************************************************************************************************/
/**
 * @brief SiVAL::NavBarPanel::~NavBarPanel
 */
SiVAL::NavBarPanel::~NavBarPanel() {
}
/**************************************************************************************************/
/**
 * @brief SiVAL::NavBarPanel::addPanel
 * @param icon
 * @param icon_hover
 * @param panel
 */
void SiVAL::NavBarPanel::addPanel(const QString &icon, const QString &icon_hover, QWidget *panel) {
    int count = m_pButtonLayout->count() - 2;
    // SiVAL::NavBarButton *toolButton = new SiVAL::NavBarButton(icon, icon_hover, this);
...
void SiVAL::NavBarPanel::appendPanel(const QString &icon, const QString &icon_hover, QWidget *panel) {
    int count = m_pButtonLayout->count() - 2;
...
void SiVAL::NavBarPanel::select(int id) {
    QAbstractButton *btn = m_pGroup->button(1);
    if(btn) {
        btn->click();//setChecked(true);
    }
}
void SiVAL::NavBarPanel::toggle(bool checked) {
    if(checked) {
        m_pPanelStack->hide();
    } else {
        m_pPanelStack->show();
...
void SiVAL::NavBarPanel::insertPanel(const QString &icon, const QString &icon_hover, int btn_id, int position, QWidget *panel) {
    // int count = m_pButtonLayout->count() - 2;
    SiVAL::NavBarButton *toolButton = new SiVAL::NavBarButton(icon, icon_hover, this);
    toolButton->setMinimumSize(QSize(48, 48));
    toolButton->setMaximumSize(QSize(48, 48));
...
void SiVAL::NavBarPanel::selection(QAbstractButton *btn) {
    Q_UNUSED(btn);
    ...
    //     emit changeview(SiVAL::CV_CharacterPage);
    // } else if(btn == ui->m_pSettings) {
    //     ui->m_pStackedWidget->setCurrentIndex(1);
    //     emit changeview(SiVAL::CV_SettingsSkill);
    // }
}
//// end protected slots
