 ...
 *
 */
SiVAL::Counter::Counter(QWidget *parent)
:QWidget(parent) {
 ...
 *
 */
SiVAL::Counter::~Counter() {
}
int SiVAL::Counter::maximum() {
    return m_iMaximumValue;
}
int SiVAL::Counter::minimum() {
    return m_iMinimumValue;
}
void SiVAL::Counter::setMaximum(int value) {
    m_iMaximumValue = value;
}
void SiVAL::Counter::setMinimum(int value) {
    m_iMinimumValue = value;
    emit valueChanged(value);
}
void SiVAL::Counter::setValue(int value) {
    m_iValue = value;
    emit valueChanged(value);
}
int SiVAL::Counter::value() {
    return m_iValue;
}
...
void SiVAL::Counter::leaveEvent(QEvent *event) {
    Q_UNUSED(event);
    button = false;
    update();
}
void SiVAL::Counter::mousePressEvent(QMouseEvent *event) {
...
void SiVAL::Counter::mouseMoveEvent(QMouseEvent *event) {
    bool b = button;
    if(event->pos().x() > width() - m_iIconWidth - m_iPaddingRight && event->pos().x() < width() - m_iPaddingRight) {
        b = true;
    } else {
...
void SiVAL::Counter::paintEvent(QPaintEvent *event) {
