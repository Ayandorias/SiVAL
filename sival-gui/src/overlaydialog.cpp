 ...
 *
 */
SiVAL::OverlayDialog::~OverlayDialog() {
    // delete m_pUi;
}
...
bool SiVAL::OverlayDialog::eventFilter(QObject *obj, QEvent *event) {
 ...
 * @param OverlayDialog
 */
void SiVAL::OverlayDialog::retranslateUi(QWidget *OverlayDialog)
{
...
//// begin public slots
void SiVAL::OverlayDialog::cancel() {
    close();
}
//// end public slots
